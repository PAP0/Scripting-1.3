	 ...
	 <body>
		...
		<div class="wrapper">
			<form method="GET" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<fieldset>
				 <legend>Patryk Podworny GD1B</legend>
			...
			?><ul>
					...
					<li>Zoeken naar "." . Er zit een  "."  op positie  <?php  echo strpos($string3, ".");  ?>  </li>
					<li>Zoek naar substring <strong>"PHP"</strong> vervang dit door <strong>"NodeJS"</strong>  <?php  echo str_replace("PHP", "NodeJS", $input1);  ?>   </li>
